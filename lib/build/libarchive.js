...
// {{PRE_LIBRARY}}
  ...
  err('missing function: posix_spawn_file_actions_addclose'); abort(-1);
  }

  function _posix_spawn_file_actions_adddup2() {
  err('missing function: posix_spawn_file_actions_adddup2'); abort(-1);
  }

  function _posix_spawn_file_actions_destroy() {
  err('missing function: posix_spawn_file_actions_destroy'); abort(-1);
  }

  function _posix_spawn_file_actions_init() {
  err('missing function: posix_spawn_file_actions_init'); abort(-1);
  }
...
var _get_next_entry = Module["_get_next_entry"] = function() {
  return Module["asm"]["_get_next_entry"].apply(null, arguments)
};

var _get_version = Module["_get_version"] = function() {
  return Module["asm"]["_get_version"].apply(null, arguments)
};
