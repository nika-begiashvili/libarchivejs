...
-s EXTRA_EXPORTED_RUNTIME_METHODS='["cwrap"]' -s EXPORTED_FUNCTIONS='["_get_version","_archive_open","_get_next_entry","_get_filedata","_archive_close","_archive_entry_filetype","_archive_entry_pathname","_archive_entry_pathname_utf8","_archive_entry_size","_archive_read_data_skip","_archive_error_string","_free"]'
